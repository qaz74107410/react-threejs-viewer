...
AMFLoader.prototype = {
	...
	parse(data) {
        ...
        function loadDocumentScale({documentElement}) {

			let scale = 1.0;
			let unit = 'millimeter';

			if ( documentElement.attributes.unit !== undefined ) {

				unit = documentElement.attributes.unit.value.toLowerCase();
        ...
        function loadMeshVolume({firstElementChild, attributes}) {

			const volume = { name: '', triangles: [], materialid: null };

			let currVolumeNode = firstElementChild;

			if ( attributes.materialid !== undefined ) {

				volume.materialId = attributes.materialid.nodeValue;
        ...
        function loadMeshVertices({firstElementChild}) {

			const vertArray = [];
			const normalArray = [];
			let currVerticesNode = firstElementChild;
        ...
        function loadObject({attributes, firstElementChild}) {

			const objId = attributes.id.textContent;
			const loadedObject = { name: 'amfobject', meshes: [] };
			let currColor = null;
			let currObjNode = firstElementChild;
